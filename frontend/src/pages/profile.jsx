...
export default function Profile() {
	...
	useEffect(() => {
		if (!userEmail) return;
		axios
			.get("/api/v2/user/profile", { params: { userEmail } })
			.then((res) => {
					...
					<div className="w-full h-max my-2 p-5">
						...
						<div className="w-full h-max flex flex-col sm:flex-row p-5 gap-10">
							<div className="w-40 h-max flex flex-col justify-center items-center gap-y-3">
								...
								<img
									src={`https://follow-along-yi6s.onrender.com/${personalDetails.avatarUrl}` || `https://cdn.vectorstock.com/i/500p/17/61/male-avatar-profile-picture-vector-10211761.jpg`}
									alt="profile"
